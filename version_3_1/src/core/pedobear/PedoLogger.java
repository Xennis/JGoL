 ...
 * @version 1.0
 */
public final class PedoLogger extends java.io.PrintWriter implements
		IPedoLogger {
	 ...
	 * 
	 */
	private PedoLogger(String fileName, boolean append, int mode,
	 ...
	 */
	private PedoLogger(String fileName, int mode, int loggingLevel)
			throws FileNotFoundException {
	 ...
	 * 
	 */
	public static IPedoLogger getNewLogger(String filename, boolean append,
		...
		return (new PedoLogger(temp + ".pbl", append, mode, loggingLevel));
	}
	 ...
	 * 
	 */
	public static IPedoLogger getNewLogger(String filename, int mode,
			int loggingLevel) throws FileNotFoundException {
		String temp;
		if (filename == "") {
			temp = "untitled";
		...
		return (new PedoLogger(temp + ".pbl", mode, loggingLevel));
	}
